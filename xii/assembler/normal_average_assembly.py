from xii.assembler.normal_average_form import *
from xii.assembler.ufl_utils import *
from xii.assembler.normal_average_matrix import normal_avg_mat
from xii.assembler.reduced_assembler import ReducedFormAssembler


class NormalAverageFormAssembler(ReducedFormAssembler):
    def __init__(self):
        self.attributes = ('naverage_', )
    ...
    def reduction_matrix_data(self, terminal):
        ...
        return {'shape': terminal.naverage_['shape']}
    ...
    def reduction_matrix(self, V, TV, reduced_mesh, data):
        ...
        return normal_avg_mat(V, TV, reduced_mesh, data)

# Expose
    
def assemble_form(form, arity, assembler=NormalAverageFormAssembler()):
