...
class AverageFormAssembler(ReducedFormAssembler):
    ...
    def restriction_filter(self, terminals, reduced_mesh):
        ...
        return set(t for t in terminals if ((topological_dim(t) - 2) == tdim or (topological_dim(t) - 1) == tdim))
    ...
    def reduction_matrix_data(self, terminal):
        ...
        return {'shape': terminal.average_['shape'], 'normalize': terminal.average_['normalize']}
